...
cars_data3=pd.read_csv(r'Programming-Knowledge--master\Toyota.csv',index_col=0)
...
cars_data1
cars_data3.insert(10,"Price_Class","")
i=0
while i<len(cars_data3['Price']):
    if (cars_data3['Price'][i]<=8450):
        cars_data3['Price_Class'][i]="Low"
    elif((cars_data3['Price'][i]>11950)):
        cars_data3['Price_Class'][i]="High"
    else:
        cars_data3['Price_Class'][i]="Medium"
    i+=1
cars_data3
...
cars_data3.insert(10,"Age_Coverted",0)
cars_data3.insert(11,"km_per_month",0)    
